...
The source repository could be also linked to configuration repository as a git submodule, but I decided that including the reference to the related commit hash in source repo is enough.
